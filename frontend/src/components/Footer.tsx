...
//     ].map((item) => (
//       <p
//         className="transition-transform transform hover:scale-[110%] hover:text-[#B0B0B0] duration-200 ease-out"
//         key={item}
//         onClick={() => handleMenuItemClick(item)} // Add the click handler
//       >
//         <Link to={`/${item.toLowerCase()}`}>{item}</Link> {/* Wrap in Link for navigation */}
//       </p>
//     ))}
//   </div>
// </div>
...
const Footer = () => {
  ...
  const handleMenuItemClick = (item: string) => {
    ...
    console.log(item); // You can add your navigation logic here if needed
  };
      ...
      <div className="bg-[#474747] flex text-[#ffffff] gap-10 p-10 flex-wrap-reverse justify-evenly mobile:text-center">
        ...
        <div className="flex flex-col justify-evenly lg-device:w-[30%]">
          <div className="flex items-center space-x-5 mobile:justify-center transition-transform transform group">
            <img
              src={logo}
              className="group-hover:scale-[110%] duration-300 ease-out cursor-pointer"
              alt="logo"
              onClick={() => navigate('/')}
            />
            <p
              className="text-4xl italic font-playfair group-hover:scale-[110%] duration-300 ease-out cursor-pointer"
              onClick={() => navigate('/')}
            >
              Foodzy
            </p>
          ...
          <div className="flex justify-start gap-5 mobile:justify-center">
            <a
              ...
              className="scale-[140%] transition-transform transform hover:scale-[170%] duration-300 ease-out"
            >
              <RiInstagramFill />
            </a>
            <a
              ...
              aria-label="Facebook"
              className="scale-125 transition-transform transform hover:scale-150 duration-300 ease-out"
            >
              <FaFacebookSquare />
            </a>
            <a
              ...
              aria-label="Twitter"
              className="scale-[120%] transition-transform transform hover:scale-[145%] duration-300 ease-out"
            >
              <FaXTwitter />
            </a>
          </div>
